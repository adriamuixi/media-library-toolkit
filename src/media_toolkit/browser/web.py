...
<main><div class="eyebrow">Local read-only media browser</div><h1>{{ library_name }}</h1><p class="lede">Organized-library media only. The toAnalyze directory is always excluded.</p>
